import { Mail, MapPin, Youtube, Facebook, Instagram, Phone, Globe } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pb-20">
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Empowering students to master mathematics with clarity and confidence.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container-custom  ">
        <div className="grid grid-cols-1 mt-20 md:grid-cols-3 gap-8">
            ...
            <div className="bg-card rounded-3xl shadow-sm border border-border p-8">
                ...
                <div className="space-y-6">
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    <span className="font-bold text-primary">Root to Nahid</span> is an innovative EdTech platform dedicated to helping BSc Mathematics students of the National University, Bangladesh. We guide you from the fundamental roots of mathematics to advanced problem-solving with clarity and confidence.
                  </p>

                  <div className="grid gap-4 py-4">
                    <div className="flex gap-4 items-start">
                       <div className="mt-2 w-2 h-2 rounded-full bg-primary shrink-0" />
                       <p className="text-muted-foreground"><strong className="text-foreground">National University Syllabus:</strong> Complete coverage of core topics with exam-focused guidance.</p>
                    </div>
                    <div className="flex gap-4 items-start">
                       <div className="mt-2 w-2 h-2 rounded-full bg-primary shrink-0" />
                       <p className="text-muted-foreground"><strong className="text-foreground">Concept-Based Learning:</strong> Step-by-step explanations that make complex ideas easy to understand.</p>
                    </div>
                    <div className="flex gap-4 items-start">
                       <div className="mt-2 w-2 h-2 rounded-full bg-primary shrink-0" />
                       <p className="text-muted-foreground"><strong className="text-foreground">Student Success:</strong> Build strong foundations and improve analytical skills for your academic journey.</p>
                    </div>
                  </div>
                ...
                <div className="bg-surface rounded-2xl p-6 flex flex-col sm:flex-row sm:items-center gap-4 border border-border">
                   ...
                   <div>
                      ...
                      <p className="text-xl font-bold text-foreground select-all">01316271902</p>
                   </div>
                </div>
            </div>
          ...
          {/* Sidebar Info */}
          <div className="space-y-6">
            <div className="bg-card rounded-3xl shadow-sm border border-border sticky top-24 p-6">
                <h3 className="text-lg font-bold mb-4 text-foreground">More Info</h3>
                ...
                <ul className="space-y-4">
                  <li className="flex items-center gap-3 text-muted-foreground hover:text-primary transition-colors">
                     ...
                     <Link href="https://www.youtube.com/@RoottoNahid" target="_blank" className="text-sm font-medium break-all">
                  ...
                  <li className="flex items-center gap-3 text-muted-foreground">
                   ...
                   <li className="flex items-center gap-3 text-muted-foreground">
                     ...
                     <span className="text-sm font-medium">View email address</span>
                  </li>
                   <li className="flex items-center gap-3 text-muted-foreground">
                     <div className="w-8 h-8 rounded-lg bg-surface flex items-center justify-center text-foreground shrink-0">
                        <Globe size={18} />
                     </div>
                     <Link href="https://root-to-nahid.vercel.app" target="_blank" className="text-sm font-medium">
